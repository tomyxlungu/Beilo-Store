...
/* Fallback images (real files) when a product asset is missing */
...
function categoryFallback(product: Product): string {
  return (
    CATEGORY_FALLBACKS[product.category] ?? FINAL_FALLBACK
  );
}

/* Deterministic pseudo rating so each product feels distinct */
...
const SAMPLE_REVIEWS = [
  {
    initials: 'CM',
    name: 'Chanda M.',
    title: 'Great fit, quality fabric!',
  },
  {
    initials: 'MK',
    name: 'Mwila K.',
    title: 'Arrived fast, love it!',
  },
  {
    initials: 'TN',
    name: 'Tendai N.',
    title: 'True to size, will buy again!',
  },
];
      ...
      items={[
        {
          ...
          answer:
            'We deliver within Lusaka in 1–2 working days and countrywide in 2–5 working days. Delivery fees are confirmed at checkout.',
        },
        {
          question: 'What is your return policy?',
          answer:
            'Changed your mind? Return unworn items with tags within 7 days for an exchange or refund. Need help? Chat to us on WhatsApp.',
        },
        {
          question: `How does ${name} fit?`,
          answer:
            'Our fits run true to size. If you are between sizes, we recommend sizing up for a relaxed fit. Check the size guide on each size for measurements.',
        },
        {
          question: 'Can I pick up in store?',
          answer:
            'Yes. Choose pickup at checkout and collect from any of our 5 stores — Lusaka, Ndola or Kitwe. We will message you when your order is ready.',
        },
        {
          question: 'How do I pay?',
          answer:
            'We accept mobile money and pay on delivery in selected areas. All payments are confirmed before dispatch.',
        },
      ]}
    />
  );
...
export default function ProductPage({ params }: PageProps) {
  ...
  const handleImageError = () => {
    const fallback = categoryFallback(product);
    if (mainSrc !== fallback) {
      setImgSrc(fallback);
    } else if (mainSrc !== FINAL_FALLBACK) {
  ...
  const whyItems = [
    {
      ...
      text: 'Hand-picked fabrics and finishes that survive everyday wear and washing.',
    },
    {
      Icon: Zap,
      title: 'Fast Delivery',
      text: 'Same-week delivery in Lusaka and countrywide shipping to your door.',
    },
    {
      Icon: RotateCcw,
      title: 'Easy Returns',
      text: '7-day exchanges and refunds. No stories, no stress — just BEILO.',
    },
  ];
  ...
  return (
    <div className="pdp">
      ...
      <div className="pdp-top">
        <div className="pdp-gallery">
          <div className="pdp-main">
            ...
            {tag && (
              <span
                className={`product-tag ${tag.modifier}`}
              >
                {tag.label}
              </span>
            )}
            ...
            >
              <Heart
                ...
                color={
                  wishlisted ? '#ef3030' : 'currentColor'
                }
              />
            </button>
          </div>
        ...
        <div className="pdp-info">
          ...
          <div className="pdp-rating-row">
            <Stars rating={rating} />
            <span className="pdp-rating-value">
              {rating.toFixed(1)}
            </span>
          ...
          <div className="pdp-actions">
            ...
            <button
              type="button"
              className="btn btn-secondary pdp-cta"
              disabled={soldOut}
      ...
      <section className="pdp-section">
        <h2 className="pdp-section-title pdp-section-title-center">
          Why {product.name}?
        </h2>
